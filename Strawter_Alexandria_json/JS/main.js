...
for (var i = 0; i < data.results.forecast.length; i++) {
  ...
  console.log("Today is " + day +". The high is "+ w[i].high + ". The low is "+ w[i].low + ". It will be " + w[i].text);
}


// 3. Console.log each of the employees showing their full names (from the object "employees"
// and jobs (from the object "people").
for (var ii = 0; ii < obj.employees.length; ii++) {
  console.log(obj.employees[ii].firstName + " " + obj.employees[ii].lastName + ". Job: "+ myJSON.people[ii].job);
}
